...
import { Client, ClientContact, SavedProposal, ThreadMessage, MeetingNote, NewsArticle, PIPELINE_STAGES, generateId, formatCurrency, formatDate } from '../../types';
              ...
              <div className="px-6 py-5 space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-[10px] text-[#DC2626]/60 font-medium">Granola / meeting notes</span>
                  </div>
                  <textarea
