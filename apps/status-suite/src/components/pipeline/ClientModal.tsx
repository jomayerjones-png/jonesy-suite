...
import { Client, ClientContact, SavedProposal, ThreadMessage, PIPELINE_STAGES, generateId, formatCurrency, formatDate } from '../../types';
...
export default function ClientModal({
  ...
  const [tab, setTab] = useState<'details' | 'contacts' | 'proposals' | 'intelligence'>('details');
              ...
              <div className="px-6 py-5 space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-[10px] text-[#E8471C]/60 font-medium">Granola / meeting notes</span>
                  </div>
                  <textarea
