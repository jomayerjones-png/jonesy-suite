    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: '#F5F0EB' }}>
      <div className="w-full max-w-sm space-y-10">
        ...
        <div className="text-center">
          <div className="inline-block bg-[#E8471C] px-4 py-2 mb-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-white border border-brand-dark/15 text-brand-dark
                           px-4 py-3 text-sm outline-none focus:border-[#E8471C] transition-colors rounded-none"
              />
            </div>
            <div className="space-y-1.5">
              <label className="block text-xs text-brand-dark/50 uppercase tracking-widest font-medium">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#E8471C] text-white text-sm font-medium tracking-widest uppercase
