    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: '#F5F0EB' }}>
      <div className="w-full max-w-sm space-y-10">
        ...
        <div className="text-center">
          <h1 className="font-display text-4xl text-brand-dark tracking-wide">
            Jonesy &amp; Co
          </h1>
          <p className="mt-2 text-xs text-brand-dark/40 uppercase tracking-[0.2em] font-medium">
            Business Suite
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-white border border-brand-dark/15 text-brand-dark
                           px-4 py-3 text-sm outline-none focus:border-brand-dark transition-colors rounded-none"
              />
            </div>
            <div className="space-y-1.5">
              <label className="block text-xs text-brand-dark/50 uppercase tracking-widest font-medium">
          ...
          {resetSent && (
            <p className="text-emerald-700 text-xs text-center">Reset email sent — check your inbox.</p>
          )}

          <button
            type="submit"
            disabled={loading}
            className="w-full bg-brand-dark text-white text-sm font-medium tracking-widest uppercase
