...
// Once the database is connected and seeded, these become unused.
...
export const MOCK_STAGES: ServiceStage[] = [
  {
    id: 'stage-1',
...
export const MOCK_PROSPECTS: PipelineProspect[] = [
  {
    id: 'prospect-1',
    client_id: 'client-life',
...
export const MOCK_UPDATES: ClientUpdate[] = [
  {
    id: 'update-1',
    client_id: 'client-life',
    prospect_id: 'prospect-1',
...
export const MOCK_PROPOSALS: Proposal[] = [
  {
    ...
    content:
      'Integrated campaign proposal for Nike featuring LIFE editorial content across digital and live activations.',
    status: 'approved',
  ...
  },
  {
    ...
    content:
      "Proposal for exclusive distribution of LIFE's flagship podcast series on Spotify, including promotional support.",
    status: 'draft',
...
export const MOCK_BD_LEADS: BDLead[] = [];
